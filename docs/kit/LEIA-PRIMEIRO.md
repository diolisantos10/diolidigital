<!-- GERADO POR scripts/espelhar-kit.mts (modo "carimbo") — NÃO EDITE À MÃO.
     A próxima rodada do robô sobrescreve qualquer edição manual. -->

# LEIA PRIMEIRO — esta pasta é espelho, não é a fonte

> ⚠️ **`docs/kit/` é uma CÓPIA AUTOMÁTICA** de `diolisantos10/dioli-brain-kit`,

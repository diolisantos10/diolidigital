...
Um registro de data e hora UNIX inteiro em segundos (por exemplo, 1530432000).
...
Em alguns casos, usar um país e uma região dele causará o erro: "Há sobreposição de algumas das suas localizações. Experimente remover uma localização." Nesses casos, direcione para a região ou o país, dependendo da cobertura que você quer.
...
Limitações
Vídeos ao vivo - Se uma publicação da Página contiver um vídeo que expirou, como uma transmissão ao vivo, você poderá obter alguns campos da publicação, mas não os campos relacionados ao vídeo. O vídeo tem suas próprias regras de privacidade. Se o vídeo expirar, você deverá ser o administrador da página para visualizar as informações dele.
CTA da mensagem: os tokens de acesso podem ser usados para solicitar posts públicos da Página, desde que seu app tenha sido aprovado para o recurso Acesso ao conteúdo público da Página. Entretanto, as publicações com mensagem de CTA não podem ser acessadas por meio do token de acesso de outra Página, pois as Páginas não podem enviar mensagens umas às outras.

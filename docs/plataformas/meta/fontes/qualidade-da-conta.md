...
As restrições de publicidade podem incluir:

Limites no valor que um anunciante pode gastar por dia ou um limite de pagamento menor
Perda de acesso a alguns recursos de pagamento
Perda de acesso a alguns recursos de publicidade
Perda da capacidade de anunciar nas plataformas da Meta

Além disso, também podemos aplicar restrições para publicidade nestas situações:

O anunciante não segue os Padrões da Comunidade, os Padrões de Publicidade da Meta, as Políticas Comerciais ou outros termos e políticas.
Suspeitamos que o portfólio empresarial ou os ativos de negócios do anunciante foram comprometidos ou hackeados. Saiba mais sobre como proteger uma conta hackeada.
Um anunciante não atende aos nossos requisitos de autenticação de dois fatores para segurança da conta.
A Meta pode aplicar limites temporários sobre quanto um anunciante pode gastar por dia, a frequência de cobrança ou quais recursos de pagamento podem ser acessados até termos certeza de que está seguindo nossas políticas de forma consistente.
A Meta identifica atividades incomuns de pagamento ou conta, altas taxas de falhas de pagamento ou contestação de pagamentos.

Você pode acessar a Página Inicial do Suporte para Empresas da Meta a fim de resolver problemas que possa encontrar em relação à conformidade com nossas políticas e padrões ou atividades incomuns na sua conta.
...
Quando percebemos atividade incomum no seu portfólio empresarial, conta de anúncios, Página ou conta de usuário, podemos restringir alguns recursos temporariamente enquanto investigamos o problema. Essas restrições podem incluir:

limitação nos gastos com publicidade ou um limite de pagamento menor
perda de acesso a alguns recursos de pagamento
perda da capacidade de adicionar administradores, parceiros ou usuários
perda da capacidade de criar novas contas de anúncios

Analise as ações que você deve realizar para tentar resolver restrições na Página Inicial de Suporte para Empresas da Meta.

Observação: saiba mais sobre como proteger uma conta invadida se suspeitar que seu ativo comercial foi hackeado.
...
Mais nesta seção: POLÍTICAS

NoÇÕes BÁsicas
Padrões de Publicidade
Lista de verificação da Política de Publicidade
Sobre o monitoramento das Políticas de Publicidade

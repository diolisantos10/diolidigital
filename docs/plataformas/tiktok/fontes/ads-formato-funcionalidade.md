...
Landing pages must be functional. Ensure that your landing page functions properly on the network of the targeted market. Different types of ads have different requirements for URL links that redirect viewers from the ad content. For more information, refer to our TikTok Ad Specifications.

If your ad or landing page does not meet our Ad Format and Functionality requirements, the performance of your ad may be affected. Based on various quality signals, including automated machine review, human review, and viewer engagement signals, your ad may be rejected, receive fewer impressions, or your ad's cost-per-impression may increase.
...
Landing pages that require viewers to download additional programs or enter personal information in order to access the main content on the landing page
...
Do not use our lead ads product to collect the following information from viewers, unless you have received written consent from a TikTok Sales Representative:
...
Ad creatives and landing pages must not disclose personal data or state or imply that the product can be used in a manner that infringes an individual's privacy. This includes displaying a real person's contact details, credit card number, government ID, etc.
...
Ad and editorial quality - Captions, text, images, audio, video
...
Language, currency and content relevance for target market

An ad's setting language is the ad targeting language, and an ad's country/location is the target market.

The language, currency and any other relevant elements of your ad content and landing page must either be consistent with the setting or be acceptable/relevant for the target market and its local context. If the setting language is not specified, the language of the ad content and landing page must be in a language that is acceptable for that target market. Otherwise, subtitles in a language that is acceptable to the target market must be included.

Additionally, spoken language (audio) within the ad content should ideally be clear, comprehensible and natural for the target market.

For currency consistency and relevance, advertisers can consider providing a currency/region switch feature to facilitate convenient toggling by users.

Market-specific exceptions and restrictions may apply. Please contact your TikTok Sales Representative for more details and any required clarifications.

The following list details the acceptable languages by market:

Australia: English

Bangladesh: Bengali, English

Brazil: Portuguese; language requirement applies exclusively to LATAM markets for Mission Ads.

Cambodia: Khmer, English

Indonesia: Bahasa Indonesia, English

For industries requiring disclaimers, these disclaimers must be presented in the local language.

...
user	user.info.basic	Read a user's profile info (open id, avatar, display name ...)	Read your profile info (avatar, display name)	
User Info

user.info.profile	Read access to profile_web_link, profile_deep_link, bio_description, is_verified.	Read your additional profile information, such as bio description, profile link, and account verification status	
User Info

user.info.stats	Read access to a user's statistical data, such as likes count, follower count, following count, and video count	Read your profile engagement statistics, such as like count, follower count, following count, and video count	
User Info

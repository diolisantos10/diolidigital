...
The safe zone size is determined by the dimension (vertical, horizontal, or square), ad caption length, and any additional formats used. Downloadable safe zone files are available below. Note: There might be slight differences between the preview and the live version since the ad preview is not specific to a device.

Standard Version (LTR): For all regions except the Arabic region.
...
Landing Pages: The account name will be automatically used as the landing page heading on an in-app browser.

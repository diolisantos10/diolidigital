...
Para garantir que a experiência no TikTok seja segura e positiva, contamos com as Diretrizes da Comunidade. Essas regras se aplicam a tudo e a todos em nossa plataforma.

Você está no lugar certo caso queira saber:
...
Agradecemos por ajudar a manter o TikTok um espaço acolhedor para todos!

Nossas regras

Nós nos esforçamos para que as Diretrizes da Comunidade sejam fáceis de entender. Elaboramos um breve resumo do que não é permitido em cada um dos principais tópicos abordados nas Diretrizes da Comunidade. Mais detalhes estão disponíveis após esta seção.
...
Desinformação: É proibida desinformação que possa causar danos significativos aos indivíduos ou à sociedade.
Integridade cívica e eleitoral: É proibido conteúdo que possa enganar eleitores ou interferir em processos eleitorais, incluindo informações falsas sobre métodos de votação, elegibilidade para votar ou resultados eleitorais.
Mídia editada e conteúdo gerado por IA (AIGC): É obrigatório o uso de identificação explícita quando IA ou edição são usadas para representar pessoas ou cenas de maneira realista. É proibido AIGC que induza ao erro sobre assuntos de importância pública ou que prejudiquem indivíduos.
...
Queremos que o TikTok seja um lugar seguro, divertido e criativo para todos. Saiba como trabalhamos para alcançar esse objetivo:

Remoção de conteúdo

Todos têm a liberdade de compartilhar no TikTok, mas, ao identificarmos conteúdo que se enquadre nas regras de "Proibido" das Diretrizes da Comunidade, ele é removido da plataforma.

Restrição de conteúdo por idade

Alguns conteúdos podem não ser adequados para pessoas menores de 18 anos. Quando algo se encaixa nos padrões de “Restrição de Idade” definidos nas Diretrizes da Comunidade, limitamos sua visualização apenas para adultos.

Padrões do feed "Para Você"

O feed "Para Você" foi criado para ajudar na descoberta de diversos conteúdos e criadores, permitindo que alcancem novas audiências e formem comunidades vibrantes. No entanto, nem todo conteúdo é garantido no processo de recomendação. Quando identificamos conteúdo que se enquadra nos padrões de “Inelegível ao feed 'Para Você'" nas Diretrizes da Comunidade, ele não será recomendado no feed "Para Você". Você pode ler mais aqui sobre o que está qualificado.

Disponibilizamos ferramentas e recursos para você se manter informado e no controle

No TikTok, você tem autonomia para gerenciar sua experiência. Oferecemos um kit de ferramentas de segurança que permite personalizar suas preferências de conteúdo e configurações da conta, além de gerenciar interações. Além disso, para alguns conteúdos, você verá telas ou banners de inscrição que oferecem mais contexto sobre uma publicação.

Você também pode acessar os recursos da nossa Central de Segurança para receber mais suporte.

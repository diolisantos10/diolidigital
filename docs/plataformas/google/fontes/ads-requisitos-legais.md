...
Em algumas circunstâncias, as violações das leis locais serão consideradas graves, resultando na suspensão da conta. Nesse caso, todos os anúncios na conta suspensa vão parar de ser veiculados, e talvez você não consiga mais anunciar usando o Google Ads ou o Display & Video 360. Também há risco de suspensão permanente de contas relacionadas, além da possibilidade de novas contas serem suspensas durante a configuração. Saiba o que acontece quando nossas políticas são violadas.
...
Você precisa cumprir as sanções e regulamentações de exportação aplicáveis, incluindo sanções da Agência de Controle de Ativos Estrangeiros (OFAC), além de concordar em não fazer com que o Google viole essas regulamentações.
 ...
 Não é permitido usar o Google Ads ou o Display & Video 360 para ajudar ou agir em nome de entidades ou indivíduos sancionados.

 Não é permitido usar o Google Ads ou o Display & Video 360 para ajudar ou agir em nome de entidades ou indivíduos localizados em regiões ou países sancionados.

O Google Ads e o Display & Video 360 não estão disponíveis para entidades ou indivíduos sujeitos a sanções comerciais aplicáveis ou leis de conformidade de exportação. Ele também não está disponível para entidades ou indivíduos que fazem parte, são controlados ou atuam em ou em nome de entidades ou indivíduos sancionados.

 Não são permitidas campanhas publicitárias que segmentam geograficamente países ou territórios embargados.

 Não são permitidas campanhas publicitárias veiculadas em nome de empresas localizadas em regiões ou países embargados, mesmo que o proprietário da conta não esteja localizado em um local embargado.

 Não são permitidas campanhas publicitárias veiculadas por ou em nome de entidades ou indivíduos sujeitos a sanções comerciais e regulamentações aplicáveis.

O Google precisa respeitar as sanções impostas pela OFAC. As entidades e os indivíduos restritos não podem criar ou usar uma conta do Google Ads ou do Display & Video 360 nem permitir que terceiros usem o produto em nome deles. As pessoas localizadas ou que residem em países ou territórios embargados não podem criar nem usar contas do Google Ads ou do Display & Video 360. No momento, os seguintes países ou regiões estão embargados: Coreia do Norte, Crimeia, Cuba, Irã e as autoproclamadas República Popular de Donetsk (DNR) e República Popular de Luhansk (LNR).

 

Saiba como corrigir uma conta suspensa.
Diretiva "Serviços de Comunicação Social Audiovisual"

...
Identificamos a causa raiz e estamos trabalhando em uma correção para esse problema.
...
Posso ter vários projetos do Google Cloud com vários níveis de acesso após essa mudança?

Sim, é possível ter vários projetos do Google Cloud com diferentes níveis de acesso à API. Por exemplo, você pode ter um projeto na nuvem do Google Cloud com acesso Basic e outro projeto na nuvem do Google Cloud com acesso padrão.
...
abcdefghijkl1234567890	1234567890	Acesso padrão	O token de desenvolvedor e o ID do projeto estão associados entre si.
abcdefghijkl1234567890	5678912345	Acesso padrão	O token de desenvolvedor e o ID do projeto estão associados entre si.
abcdefghijkl1234567890	45678912345	Acesso padrão	O token de desenvolvedor e o ID do projeto estão associados entre si.
xyzabcdefghi6789012345	1231235678	Acesso básico	O token de desenvolvedor e o ID do projeto estão associados entre si.
...
Os níveis de acesso do seu token de desenvolvedor ativo foram transferidos para seu projeto do Google Cloud. Portanto, o código atual vai continuar funcionando sem mudanças. Se você precisar usar um novo projeto do Google Cloud, solicite acesso à API na página de visão geral da API Google Ads do projeto.

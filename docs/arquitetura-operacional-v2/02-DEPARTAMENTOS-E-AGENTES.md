...
- Agente de CRM de Oportunidades

**Entrega ao próximo departamento:** oportunidade qualificada, briefing inicial, contato responsável e origem.
...
- Agente de Ciclos e Recorrência

**Não faz:** criação especializada, auditoria final ou alteração silenciosa de escopo.
...
- Agente de Oferta e Posicionamento
- Agente de Planejamento de Campanhas

**Entrega:** diagnóstico, objetivos, público, mensagem, canais, KPIs e direção recomendada.
...
- Agente de Moodboard e Identidade
- Agente Brand Auditor e Evolution

**Entrega:** regras aplicáveis da marca, Brand Space mutável, lacunas, score e histórico de evolução.
...
- Agente Copywriter
- Agente Community Manager e SAC
- Agente de Trends e Radar
- Agente de Publicação e Distribuição

**Entrega:** calendário, conteúdo, legendas, distribuição, respostas e aprendizados.

## 6. Design e Produção Criativa
...
- Agente de Vídeo e Edição
- Agente de Adaptação e Desdobramento
- Agente de Biblioteca Criativa

**Entrega:** arquivos versionados, formatos finais, fontes e vínculo com briefing/brand rules.

## 7. Tráfego Pago e Performance
...
- Agente Otimizador de Campanhas
- Agente Guardião de Verba
- Agente de Análise Criativa de Performance

**Entrega:** plano de mídia, campanhas, orçamento, tracking, otimizações e resultados.
...
- Agente de Insights
- Agente de Atribuição e Funil
- Agente de Previsão e Alertas

**Entrega:** métricas confiáveis, diagnóstico, causalidade estimada, alertas e recomendação.

## 9. Qualidade e Compliance
...
- Agente Revisor de Conteúdo e Fatos
- Agente de Políticas e Risco Técnico
- Agente Approval Gate

**Entrega:** aprovação, reprovação fundamentada ou exceção registrada.

## 10. Financeiro e Administrativo
...
- Agente de Cobrança
- Agente de Rentabilidade por Cliente

**Entrega:** preço, proposta, contrato, cobrança, custo e margem.

## 11. Operações, Sistemas e Segurança
...
- Agente de Backup e Continuidade

...
> 🏷️ **Selo:** conferido contra a ficha `agentes/seguranca-v1.0.md` (v1.1,
...
> ⚖️ **Régua de atuação: 55% operacional.** **Você DECIDE E FAZ.** Seu padrão é produzir a parte que exige o seu julgamento e distribuir o resto.

...
const STATUS_CFG: Record<ClientRequestStatus, {
  ...
  waiting_strategy: { title: "Em planejamento",          message: "Nossa equipe está estruturando o plano ideal para o seu projeto com base no briefing enviado.",        nextStep: "Estruturação do escopo e proposta", estimate: "Retorno em até 48 horas úteis", currentStep: 2, color: "indigo" },
  waiting_social:   { title: "Em planejamento",          message: "Nossa equipe está preparando o planejamento de conteúdo do seu projeto.",                              nextStep: "Estruturação do escopo e proposta", estimate: "Retorno em até 48 horas úteis", currentStep: 2, color: "indigo" },
  waiting_design:   { title: "Em criação visual",        message: "Nossa equipe está desenvolvendo a direção visual e os materiais gráficos do seu projeto.",              nextStep: "Entrega dos conceitos visuais", estimate: "Retorno em até 72 horas úteis", currentStep: 3, color: "amber"  },
  waiting_traffic:  { title: "Preparando campanhas",     message: "Nossa equipe está estruturando as campanhas de tráfego pago para impulsionar seus resultados.",           nextStep: "Ativação das campanhas",        estimate: "Retorno em até 72 horas úteis", currentStep: 3, color: "indigo" },
  waiting_analytics: { title: "Analisando resultados",   message: "Nossa equipe está configurando os KPIs e o modelo de atribuição para medir com precisão os resultados do seu projeto.", nextStep: "Relatório de performance",     estimate: "Retorno em até 72 horas úteis", currentStep: 3, color: "green"  },
  waiting_quality:   { title: "Revisão final de qualidade", message: "Nossa equipe está realizando a auditoria final de qualidade antes de iniciar a execução do seu projeto.", nextStep: "Início da execução",           estimate: "Retorno em até 24 horas úteis", currentStep: 4, color: "indigo" },
  ...
  approved:         { title: "Aprovado como cliente",    message: "Sua solicitação foi aprovada. Nossa equipe entrará em contato para os próximos passos.", nextStep: "Aguardar contato da equipe",    estimate: "Em breve",                      currentStep: 4, color: "green"  },

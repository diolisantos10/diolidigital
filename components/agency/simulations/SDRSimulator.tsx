...
const PRESETS: Preset[] = [
  {
    ...
    scenario: [
      ...
      "Então pode reduzir para um plano mais simples",
    ],
  },
  {
    id: "manicure",
...
function CartPanel({
  ...
  const QUICK_ACTIONS = [
    { label: "Um plano mais simples", text: "Quero começar com um plano mais simples e barato", show: scope.wantsSocialMedia && (scope.social?.postsPerWeek ?? 0) * 4 > 8 },

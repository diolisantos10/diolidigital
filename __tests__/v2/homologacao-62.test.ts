...
// primeiro piloto". Este arquivo É a homologação: passa as 81 funções pelo
...
// ---- 2. o golden set das 81 ----------------------------------------------

describe("homologação — as 81 funções passam pelos três casos do golden set", () => {
...
describe("homologação — handoff entre departamentos na tabela HandoffV2 real", () => {
  ...
  it("as specs das 81 fecham um grafo de handoff sem ponta solta (recebe_de/entrega_para conhecidos)", () => {

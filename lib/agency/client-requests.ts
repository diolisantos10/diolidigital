...
export const REQUEST_STATUS_STYLE: Record<ClientRequestStatus, { bg: string; text: string }> = {
  ...
  waiting_strategy: { bg: "bg-[#EFF4FF]",  text: "text-[#0057FF]"  },
  waiting_social:   { bg: "bg-[#E9EFFF]",  text: "text-[#0057FF]"  },
  waiting_design:   { bg: "bg-[#E6FBFA]",  text: "text-[#0891B2]"  },
  waiting_traffic:  { bg: "bg-[#F0FBFE]",  text: "text-[#0891B2]"  },

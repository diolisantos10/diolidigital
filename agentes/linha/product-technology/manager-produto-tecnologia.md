# Ficha — Gerente de Produto & Tecnologia (`manager-produto-tecnologia`) · v1.0
...
| Campo | Valor |
|---|---|
| **Departamento** | Produto & Tecnologia (`product-technology`) |
...
| **Distribui para** | technology-orchestrator, software-architect, product-designer, design-system-engineer, frontend-engineer, backend-engineer, fullstack-engineer |
...
```
CEO → Diretor → Gerente Geral → **este cargo: Gerente de Produto & Tecnologia** → `technology-orchestrator`, `software-architect`, `product-designer`, `design-system-engineer`, `frontend-engineer`, `backend-engineer`, `fullstack-engineer`
```
...
```json
{
  "funcao": "manager-produto-tecnologia",

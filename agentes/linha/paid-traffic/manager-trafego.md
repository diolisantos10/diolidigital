# Ficha — Gerente de Tráfego Pago e Performance (`manager-trafego`) · v1.0
...
| **Distribui para** | media-planner, campaign-builder, pixel-events-tracking, campaign-optimizer, budget-guardian, creative-performance-analysis |
...
```
CEO → Diretor → Gerente Geral → **este cargo: Gerente de Tráfego Pago e Performance** → `media-planner`, `campaign-builder`, `pixel-events-tracking`, `campaign-optimizer`, `budget-guardian`, `creative-performance-analysis`
```

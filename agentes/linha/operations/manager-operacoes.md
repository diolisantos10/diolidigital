# Ficha — Gerente de Operações, Sistemas e Segurança (`manager-operacoes`) · v1.0
...
| **Distribui para** | integration-manager, credentials-and-access, scheduler-and-recovery, observability, security-and-audit, backup-and-continuity |
...
```
CEO → Diretor → Gerente Geral → **este cargo: Gerente de Operações, Sistemas e Segurança** → `integration-manager`, `credentials-and-access`, `scheduler-and-recovery`, `observability`, `security-and-audit`, `backup-and-continuity`
```

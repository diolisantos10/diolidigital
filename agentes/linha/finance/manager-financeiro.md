# Ficha — Gerente de Financeiro e Administrativo (`manager-financeiro`) · v1.0
...
| **Distribui para** | pricing-and-margin, commercial-proposal, contracts-and-documents, billing, collection, client-profitability |
...
```
CEO → Diretor → Gerente Geral → **este cargo: Gerente de Financeiro e Administrativo** → `pricing-and-margin`, `commercial-proposal`, `contracts-and-documents`, `billing`, `collection`, `client-profitability`
```

# Ficha de departamento — Estratégia (`strategy`)
...
**Decidir o caminho antes da produção.** Entrega ao próximo da esteira: diagnóstico, objetivos, público, mensagem, canais, KPIs e direção recomendada.
...
| `offer-and-positioning` | Agente de Oferta e Posicionamento | Médio |
| `campaign-planning` | Agente de Planejamento de Campanhas | Médio |

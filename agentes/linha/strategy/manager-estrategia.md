# Ficha — Gerente de Estratégia (`manager-estrategia`) · v1.0
...
| **Distribui para** | marketing-strategist, market-and-competitor-research, audience-journey-personas, offer-and-positioning, campaign-planning |
...
```
CEO → Diretor → Gerente Geral → **este cargo: Gerente de Estratégia** → `marketing-strategist`, `market-and-competitor-research`, `audience-journey-personas`, `offer-and-positioning`, `campaign-planning`
```

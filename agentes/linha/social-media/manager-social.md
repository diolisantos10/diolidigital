# Ficha — Gerente de Social Media (`manager-social`) · v1.0
...
| **Distribui para** | social-strategist, editorial-planner, copywriter, community-and-sac, trends-and-radar, publishing-and-distribution |
...
```
CEO → Diretor → Gerente Geral → **este cargo: Gerente de Social Media** → `social-strategist`, `editorial-planner`, `copywriter`, `community-and-sac`, `trends-and-radar`, `publishing-and-distribution`
```

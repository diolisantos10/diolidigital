# Ficha de departamento — Project Management (`project-management`)
...
**Transformar a demanda em projeto executável e coordenar toda a esteira.** Entrega ao próximo da esteira: projeto com ordem, donos, prazos, handoffs aceitos e comunicação única com o cliente.
...
| `client-communication` | Agente de Comunicação com o Cliente | Alto |
| `cycles-and-retention` | Agente de Ciclos e Recorrência | Médio |

# Ficha — Gerente de Atendimento e SDR (`manager-atendimento`) · v1.0
...
| **Distribui para** | prospecting, conversational-sdr, qualification, initial-diagnosis, opportunity-crm |
...
```
CEO → Diretor → Gerente Geral → **este cargo: Gerente de Atendimento e SDR** → `prospecting`, `conversational-sdr`, `qualification`, `initial-diagnosis`, `opportunity-crm`
```

# Ficha — Gerente de Analytics e Inteligência (`manager-analytics`) · v1.0
...
| **Distribui para** | data-integration, bi-analyst, insights, attribution-and-funnel, forecast-and-alerts |
...
```
CEO → Diretor → Gerente Geral → **este cargo: Gerente de Analytics e Inteligência** → `data-integration`, `bi-analyst`, `insights`, `attribution-and-funnel`, `forecast-and-alerts`
```

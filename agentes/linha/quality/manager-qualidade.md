# Ficha — Gerente de Qualidade e Compliance (`manager-qualidade`) · v1.0
...
| **Distribui para** | qa-orchestrator, brief-adherence, brand-compliance, content-and-fact-review, policy-and-technical-risk, approval-gate |
...
```
CEO → Diretor → Gerente Geral → **este cargo: Gerente de Qualidade e Compliance** → `qa-orchestrator`, `brief-adherence`, `brand-compliance`, `content-and-fact-review`, `policy-and-technical-risk`, `approval-gate`
```

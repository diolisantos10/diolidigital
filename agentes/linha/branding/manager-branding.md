# Ficha — Gerente de Branding (`manager-branding`) · v1.0
...
| **Distribui para** | brand-architect, brand-interviewer, brandbook-and-assets, tone-of-voice, moodboard-and-identity, brand-audit-and-evolution |
...
```
CEO → Diretor → Gerente Geral → **este cargo: Gerente de Branding** → `brand-architect`, `brand-interviewer`, `brandbook-and-assets`, `tone-of-voice`, `moodboard-and-identity`, `brand-audit-and-evolution`
```

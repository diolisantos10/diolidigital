# Ficha de departamento — Branding (`branding`)
...
**Construir, documentar, proteger e evoluir a marca.** Entrega ao próximo da esteira: regras aplicáveis da marca, Brand Space mutável, lacunas, score e histórico de evolução.
...
| `tone-of-voice` | Agente de Tom de Voz | Baixo |
| `moodboard-and-identity` | Agente de Moodboard e Identidade | Baixo |
| `brand-audit-and-evolution` | Agente Brand Auditor e Evolution | Médio |
